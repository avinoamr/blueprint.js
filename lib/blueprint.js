...
(function() {
    ...
    var blueprint = ({ 
        ...
        .configure( function () {
            this._decorators = [];
            this.applyDecorators = function( name, value ) {
        ...
        .configure( function () {
            this.directive = function( name, fn ) {
                fn = this.applyDecorators( name, fn );
                this[ name ] = fn;
                return this;
            }
        })
        ...
        .directive( "decorate", function ( name, decorator ) {
            ...
            decorator = this.applyDecorators( name, decorator );
        ...
        .directive( "define", function ( name, value ) {
            value = this.applyDecorators( name, value );
        ...
        .directive( "then", function ( fn ) {
            ...
            fn = this.applyDecorators( last.name, fn );
